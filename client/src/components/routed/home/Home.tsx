  ...
  return (
    <div className="Home">
      ...
      <div className="Home__buttons-container">
        <div
          className="Home__buttons-container__button"
      ...
      <div className="Home__awards-video-container">
        <div className="Home__awards-video-container__awards">
          <img
            className="Home__awards-video-container__awards__award"
            src="https://i.vimeocdn.com/video/1130700644-42ddee99f23cc93fa3ce5f9f194ddc973e9cab60a16c3287eb77a29e3766cca6-d_640"
            alt="Award 1"
          />
          <img
            className="Home__awards-video-container__awards__award"
            src="https://www.apac-insider.com/wp-content/uploads/2021/12/2021-Business-Awards-Logo.png"
            alt="Award 2"
          />
          <img
            className="Home__awards-video-container__awards__award"
            src="https://uploads-ssl.webflow.com/63d0c0eba09ce145300e7e3f/640159b5eb56cc7c903fefcf_webp.webp"
            alt="Award 3"
          />
        </div>
