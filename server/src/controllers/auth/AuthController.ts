...
import { findUserByMicrosoftId, createUser, findUserById } from '../../services/user/UserService';
...
export const microsoftAuthCallback = async (req: Request, res: Response): Promise<void> => {
  try {
    if (!req.user) {
